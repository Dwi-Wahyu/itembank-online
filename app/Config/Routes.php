...
$routes->group('api/sync', ['namespace' => 'App\Controllers\Api'], static function($routes) {
    $routes->get('export-teori/(:segment)', 'SyncController::exportTeori/$1');
    $routes->post('import-results', 'SyncController::importResults');
    $routes->get('list-sessions', 'SyncController::listSessions');
    $routes->get('export-osce/(:segment)', 'SyncController::exportOsce/$1');
    $routes->post('import-osce-results', 'SyncController::importOsceResults');
    $routes->get('list-osce-sessions', 'SyncController::listOsceSessions');
});
